...
> 状态：历史记录
> 所属：复盘
> 规则效力：历史事实、Review 记录与改进输入
> 维护角色：产品负责人 / 系统架构师

本目录保存零阶段复盘、架构 Review 和系统架构师复盘。复盘文档不自动成为当前规则，只有被吸收进产品、协作、架构或执行基线后才具备对应效力。
...
- 复盘记录用于追溯事实、解释、建议、返工原因和改进输入。
- 执行任务时不应直接把复盘建议当成当前规则。
- 需要吸收为规则的内容，应同步更新到对应当前基线文档，并在复盘中记录确认结果。
