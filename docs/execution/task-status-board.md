...
| T10 Worktree 与任务隔离最小治理 | 待复核 | Claude | T3，T7 | [45-t10-worktree-isolation-start-package.md](45-t10-worktree-isolation-start-package.md) | [48-t10-worktree-isolation-result.md](48-t10-worktree-isolation-result.md) | [49-t10-review-by-codex.md](49-t10-review-by-codex.md) | `npm run check`、`npm test`、`node src/worktree/isolation-governance.verify.js`（44/44 通过）；P1 修复完成 | 无 | 待 Codex 复核。 |
