...
| T4 Agent CLI 适配与最小调用闭环 | 未开始 | Codex | T1 | [29-t4-agent-cli-adapter-start-package.md](29-t4-agent-cli-adapter-start-package.md) | 待补充 | Claude | 待补充 | 无 | 按启动包启动 T4；优先在独立 branch/worktree 中实施，并复用 T3 结构化回写能力。 |
| T5 工作项状态机 | 待 Review | Claude | T3；A6 已关闭 | [32-t5-work-item-state-machine-start-package.md](32-t5-work-item-state-machine-start-package.md) | [33-t5-work-item-state-machine-result.md](33-t5-work-item-state-machine-result.md) | Codex | `npm run check`、`npm test`、`node src/work-items/state-machine.verify.js`（46 通过） | 无 | Codex 复核中（见 [34-t5-review-by-codex.md#复核记录claude-修正后](34-t5-review-by-codex.md#复核记录claude-修正后)）。 |
| T6 A2A 事件编排与记录 | 未开始 | Claude | T3，T4 | 待补充 | 待补充 | Codex | 待补充 | 等待 T4 最小 Agent 调用闭环 | T4 完成或明确可用接口后启动。 |
| T7 方案与任务拆解流程 | 未开始 | Codex | T3，T5，T6 | 待补充 | 待补充 | Claude | 待补充 | 等待 T5/T6 | T5/T6 完成后启动。 |
| T8 Harness 核心护栏 | 未开始 | Codex | T5，T7 | 待补充 | 待补充 | Claude | 待补充 | 等待 T5/T7 | T5/T7 完成后启动；必须遵守任务启动包执行落地确认。 |
| T9 Review 与质量门禁记录 | 未开始 | Claude | T3，T8 | 待补充 | 待补充 | Codex | 待补充 | 等待 T8 | T8 启动后可准备方案。 |
| T10 Worktree 与任务隔离最小治理 | 未开始 | Claude | T3，T7 | 待补充 | 待补充 | Codex | 待补充 | 等待 T7 | T7 完成后启动或由系统架构师确认是否提前拆分。 |
