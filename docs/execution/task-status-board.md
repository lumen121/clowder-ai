...
| T4 Agent CLI 适配与最小调用闭环 | 未开始 | Codex | T1 | 待补充 | 待补充 | Claude | 待补充 | 无 | 生成 T4 启动包，按标准任务闭环推进；可参考 T3 当前持久化与页面查询结果。 |
| T5 工作项状态机 | 未开始 | Codex | T3；A6 已关闭 | 待补充 | 待补充 | Claude | 待补充 | 无 | 可在 T4/T6 并行规划后启动；启动前读取架构确认文档。 |
