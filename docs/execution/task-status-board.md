...
| T5 工作项状态机 | 未开始 | Claude | T3；A6 已关闭 | [32-t5-work-item-state-machine-start-package.md](32-t5-work-item-state-machine-start-package.md) | 待补充 | Codex | 待补充 | 无 | 可与 T4 并行启动；按启动包先输出方案，确认无冲突后实施。 |
