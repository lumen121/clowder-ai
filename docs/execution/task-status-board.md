...
| T9 Review 与质量门禁记录 | 未开始 | Claude | T3，T8 | [50-t9-review-quality-gate-start-package.md](50-t9-review-quality-gate-start-package.md) | 待补充 | Codex | 待补充 | 无 | 可启动；必须先做启动前方案确认。 |
